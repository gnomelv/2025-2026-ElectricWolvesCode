...
public class Red_Close_T extends OpMode {
    ...
    private final Pose startPose = new Pose(120,127,-53);
    private final Pose closeShoot = new Pose(90,90,0);
    private final Pose PPG_Pickup = new Pose(103,84,0);
    private final Pose PPG_End = new Pose(123,84,0);
    private final Pose park = new Pose(110,90,0);
