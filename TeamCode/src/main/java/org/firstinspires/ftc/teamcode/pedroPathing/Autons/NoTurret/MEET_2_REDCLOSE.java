...
public class MEET_2_REDCLOSE extends OpMode {
   ...
   private boolean shotsTriggered = false;
    ...
    private final Pose startPose = new Pose(24, 127, Math.toRadians(-37)).mirror();
    private final Pose closeScore = new Pose(60, 95, Math.toRadians(-40)).mirror();
    private final Pose PPG_pickup = new Pose(50, 85, Math.toRadians(-180)).mirror();
    private final Pose PPG_end = new Pose(15, 85, Math.toRadians(-180)).mirror();
