...
public class Blue_Far_T extends OpMode {
    ...
    private final Pose startPose = new Pose(88,8,0).mirror();
    private final Pose farShoot = new Pose(88,12,0).mirror();
    private final Pose GPP_Pickup = new Pose(103,35,0).mirror();
    private final Pose GPP_End = new Pose(123,35,0).mirror();
    private final Pose park = new Pose(95,20,0).mirror();
